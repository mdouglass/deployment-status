...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const params = Object.assign(Object.assign({}, context.repo), { deployment_id: parseInt(deploymentId), state, log_url: defaultUrl, target_url: url, description, environment_url: environmentUrl });
            core.warning(JSON.stringify(params));
            const res = yield client.repos.createDeploymentStatus(params);
